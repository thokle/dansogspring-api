...
import com.kleistit.farmapi.handlers.user.*;
...
//bind(KafkaConsumer.class).to(KafaConsumerImpl.class).asEagerSingleton();;
 ...
 bind(AddSalePlaceHandler.class).asEagerSingleton();
 bind(AddSalePlaceToUserHandler.class).asEagerSingleton();
 bind(GetSalePlacesByUserHandler.class).asEagerSingleton();
 bind(GetUserByEmailHandler.class).asEagerSingleton();
        //Services
        ...
        bind(IRabbitSalePlacesService.class).to(RabbitSalePlacesService.class).asEagerSingleton();
        bind(RabbitService.class).asEagerSingleton();
    }
